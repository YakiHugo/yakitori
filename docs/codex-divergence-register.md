...
- Yakitori: working tree based on commit `08c405c`, including the C6 recovery
  and documentation changes recorded on 2026-08-31. C3 was audited against the
  current working tree on the same date; code and focused tests remain
  authoritative while that work is uncommitted.
